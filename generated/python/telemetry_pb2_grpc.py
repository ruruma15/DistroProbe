...
class TelemetryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamMetrics = channel.stream_unary(
                '/telemetry.TelemetryService/StreamMetrics',
                request_serializer=telemetry__pb2.LatencyMetric.SerializeToString,
                response_deserializer=telemetry__pb2.CollectorAck.FromString,
...
def add_TelemetryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StreamMetrics': grpc.stream_unary_rpc_method_handler(
                    ...
                    request_deserializer=telemetry__pb2.LatencyMetric.FromString,
                    response_serializer=telemetry__pb2.CollectorAck.SerializeToString,
            ),
    }
...
class TelemetryService(object):
    ...
    def StreamMetrics(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            target,
            '/telemetry.TelemetryService/StreamMetrics',
            telemetry__pb2.LatencyMetric.SerializeToString,
            telemetry__pb2.CollectorAck.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
